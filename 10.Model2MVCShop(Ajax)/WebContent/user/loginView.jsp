	...
	$(function(){
	  ...
	  function loginWithKakao() {
		...
		function kakaoUser(res){
		 ...
		 function kakaogetUser(res){
		    	var userId = res.id;
		    	$.ajax( 
						{
							url : "/user/json/kakaogetUser/"+userId ,
							method : "GET" ,
							dataType : "json" ,
							headers : {
								"Accept" : "application/json",
		...
		function kakaologin(id) {
			$.ajax(
					{
					url : "/user/json/kakaologin/"+id,
					method : "GET",
					dataType : "json",
					headers : {
								"Accept" : "application/json",
					...
					success : function(JSONData, status) {
						$(parent.document.location).attr("href", "/layout/top.jsp");
						window.close();
				}
			});
		}
