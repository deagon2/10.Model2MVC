	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#export").on(
					...
					function() {
						$(window.parent.frames["rightFrame"].document.location)
								.attr("href","/product/listProduct.do?menu=manage");
			...
			$(".Depth03:contains('구매이력조회')").on(
					...
					function() {
						...
						//alert(  $( ".Depth03:contains('회원정보조회')" ) );
						$(window.parent.frames["rightFrame"].document.location)
								.attr("href","/purchase/listPurchase?buyerId=${user.userId}");
					});
...
<c:if test="${user.role == 'admin'}">
	<tr>
		<td valign="top"> 
			<table  border="0" cellspacing="0" cellpadding="0" width="159">
				<tr>
					<td class="Depth03" id ="import">
						<!-- <a href="../product/addProductView.jsp;" target="rightFrame">--> 
						판매상품등록 
					</td>
				</tr>
				<tr>
					<td class="Depth03" id ="export">
						<!-- <a href="/product/listProduct.do?menu=manage"  target="rightFrame"> -->
						판매상품관리
					</td>
				</tr>
				<tr>
...
<tr>
	<td valign="top"> 
		<table  border="0" cellspacing="0" cellpadding="0" width="159">
			<tr>
				<td class="Depth03">
					<!-- <a href="/listProduct.do?menu=search" target="rightFrame"> -->
					상 품 검 색
				</td>
			</tr>
			...
			<tr>
				<td class="Depth03">
					<%-- <a href="/purchase/listPurchase?buyerId=${user.userId}"  target="rightFrame"> --%>
					구매이력조회
				</td>
			</tr>
			</c:if>
			...
			<tr>
				<td class="Depth03"><!-- <a href="javascript:history()"> -->
				최근 본 상품
				</td>
			</tr>
		</table>
